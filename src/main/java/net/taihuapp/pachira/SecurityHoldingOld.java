...
public class SecurityHoldingOld extends LotHolding {

    private static final Logger mLogger = Logger.getLogger(SecurityHoldingOld.class);
    ...
    public SecurityHoldingOld(String n) {
        super(n);
        //this(n, null);
    }
